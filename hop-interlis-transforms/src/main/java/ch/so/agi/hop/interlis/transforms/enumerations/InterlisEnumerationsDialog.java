...
/** INTERLIS Enumerations dialog: model source for the enumeration lookup rows. */
public class InterlisEnumerationsDialog extends BaseTransformDialog {

  private final InterlisEnumerationsMeta input;

  private TextVar wModelNames;
  private TextVar wModelDirectories;

  public InterlisEnumerationsDialog(
      Shell parent,
      IVariables variables,
      InterlisEnumerationsMeta transformMeta,
  ...
  public String open() {
    ...
    shell.setText("INTERLIS Enumerations");
    shell.setMinimumSize(700, 280);
